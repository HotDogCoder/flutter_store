...
class MockCategorieRepository extends Mock implements AbstractCategorieRepository {}
...
void main(){
  ...
  final Categorie categorie = Categorie(id_categorie: 1, description: 'Panes', created_by: '2022-02-21', updated_by: '2022-02-21');

  test(
    'should show a specific categorie data : ',
    () async {
      ...
      final result = await usecase(id_categorie: id_categorie);
